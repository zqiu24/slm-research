...
# poet_lie_orth_out_only: pure one-sided POETX (OutOnlyPOETXLinear, trains ONLY oft_R_out;
# oft_R_in stays identity) on the champion lie_ortho recipe. Same harness as
