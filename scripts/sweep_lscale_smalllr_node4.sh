#!/usr/bin/env bash
# Node 4 of the small-LR learnable-scale probe (§2.18): normalized s1, two smallest gentle gains.
#   lss_norm_s1_m0p03 (gain LR 1.5e-4)
#   lss_norm_s1_m0p01 (gain LR 5e-5)
...
ARMS=(lss_norm_s1_m0p03 lss_norm_s1_m0p01)
