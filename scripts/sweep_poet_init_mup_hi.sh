...
#   NORM  = optim.poet.mup_alpha {2.0,4.0,6.0,9.0}  (init_scale stays 1.0)
...
ALPHAS=("a200:2.0" "a400:4.0" "a600:6.0" "a900:9.0")   # spectral-norm target scale
...
echo "=== POET init/mup HI sweep complete: 12 runs + sanity (baseline 3.5160) ==="
