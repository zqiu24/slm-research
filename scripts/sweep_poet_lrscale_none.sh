...
#   bash scripts/sweep_poet_lrscale_none.sh        # default GPU 0-3 (dp=4, global_batch=1024), sequential
set -uo pipefail
...
echo "=== POET lr x scale sweep (init none, scale 4.0/c6) complete: 12 runs (baseline 3.4804) ==="
