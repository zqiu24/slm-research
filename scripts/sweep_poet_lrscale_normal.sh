...
#   bash scripts/sweep_poet_lrscale_normal.sh        # full 8-GPU node (dp=8, global_batch=1024), sequential
set -uo pipefail
...
echo "=== POET lr x scale sweep (init normalized, scale 2.0/c6) complete: 15 runs (baseline 3.4809) ==="
