...
| 3 | adam (dense, lr 3e-3) | 3.4935 | 32.90 | 3.3935 | **3e-3** | — | — | re-tuned dense baseline (`ebndt1qj`); −0.042 behind muon_kimi, beats best POET by **−0.022** |
| 4 | poet_lie_orth (+alt, no-head, **Nesterov b1.95**, lr4e-3/c8) — legacy | **3.5152** | 33.62 | 3.4148 | **4e-3** | 8 (**0.016**) | **no** | 🥇 **NEW BEST POET / best PEFT** recipe (`ut682296`, side-branch `lie_nesterov`); **CONFIRMED on current main** by `nestON_lr4`=3.5160 (#5) — this is the recipe now baked into config defaults |
| 5 | poet_lie_orth (+alt, no-head, **Nesterov b1.95**, lr4e-3/c8) — current main | **3.5160** | 33.65 | 3.4218 | **4e-3** | 8 (**0.016**) | **no** | **current-main confirmation** (`nestON_lr4`, `lie_ortho_nesterov=true lie_b1=0.95`); reproduces legacy 3.5152 (Δ0.0008), beats the non-Nesterov champ 3.5231 by **−0.0071**. Deconfound: nestOFF b1.95 best = 3.5247 ≈ b1=0.9 champ → the gain is the look-ahead, NOT the b1 bump |
| 6 | poet_lie_orth (+alt, no-head, Nesterov b1.95, lr3e-3/c8) | 3.5208 | 33.81 | 3.4255 | 3e-3 | 8 (0.012) | no | `nestON_lr3` — 2nd-best Nesterov cell, also beats the non-Nesterov champ (3.5231) |
| 7 | poet_lie_orth (+alt, no-head, lr4e-3/c8) | 3.5231 | 33.89 | 3.4233 | **4e-3** | 8 (**0.016**) | **no** | prior **non-Nesterov** champ (`ghsu7t8y`, cosine grid); superseded by Nesterov b1.95 (#4/#5) by −0.007 |
| 8 | poet_lie_orth (+alt, no-head, current Nesterov **b1=0.9**, lr6e-3/c8) | 3.5271 | 34.02 | 3.4264 | **6e-3** | 8 (**0.024**) | no | best `lie_b1=0.9` Nesterov cell (`nest_lr0.006` / `fnuit4pe`); b1=0.9 misses by +0.004 — the **b1=0.95** bump is what makes Nesterov a win (#4/#5) |
| 9 | poet_lie_orth (+alt, no-head, lr3e-3/c12) | 3.5274 | 34.04 | 3.4277 | 3e-3 | 12 (0.018) | no | `owcyd976` — angle 0.018 also stable+strong (old doc wrongly called 0.018 divergent) |
| 10 | poet_lie_orth (+alt, no-head, lr4e-3/s0.25/c12) | 3.5288 | 34.08 | 3.4278 | 4e-3 | 12 (0.012) | no | `q60mrt7u` — at angle 0.012, dense-lr 4e-3 beats 3e-3 (hotter dense helps) |
| 11 | muon_kimi (lr 1e-3 — old baseline) | 3.5321 | 34.20 | 3.4219 | 1e-3 | — | — | under-tuned; lr 4e-3 + wd 0.1 (#1) is **−0.081** better (`of4bakqd`; `ijq33tle` rerun 3.5251) |
| 12 | poet_lie_orth (+alt, no-head, lr3e-3/c8) | 3.5332 | 34.23 | 3.4334 | 3e-3 | 8 (0.012) | no | prior best POET (`1ynrrimu`); reproduced by `li3sflwl`, `wj68pgey` |
| 13 | poet_lie_orth (c8, no-head, both-sides) | 3.5528 | 34.91 | 3.4557 | 3e-3 | 8 (0.012) | no | both-sides head-off (`dwynpk9y`; fresh rerun `f4f49v4f` = 3.5504) |
| 14 | adam (dense, lr 1e-3 — old baseline) | 3.5570 | 35.06 | 3.4575 | 1e-3 | — | — | under-tuned; lr 3e-3 (#3) is −0.064 better (`ylrd45af`) |
| 15 | poet_lie_orth (c8, head) | 3.5667 | 35.40 | 3.4693 | 3e-3 | 8 (0.012) | yes | head-aligned twin (`7lncmww7`, distributed=true) |
| 16 | muon_hybrid | 3.5698 | 35.51 | 3.4705 | — | — | — | |
| 17 | poet_lie_orth (c4) | 3.5715 | 35.57 | 3.4701 | 3e-3 | 4 (0.006) | yes | run `z1gpz9y7` |
| 18 | poet_lie_rms | 3.6193 | 37.31 | 3.5220 | 3e-3 | 4 (rms) | no | best RMS-family (`98293d1u`; head-aligned twin `l2pzawa4` 3.6335 — worse) |
| 19 | poet_dense_rms (c8) | 3.6344 | 37.88 | 3.5367 | 1e-3 | 8 (rms) | no | |
| 20 | poet_lie_rms (c8) | 3.6404 | 38.11 | 3.5367 | 1e-3 | 8 (rms) | no | |
| 21 | poet_lie | 3.6474 | 38.37 | 3.5437 | 1e-3 | — | no | Stage 1 |
| 22 | poet_lie_rms (c4) | 3.6496 | 38.46 | 3.5478 | 1e-3 | 4 (rms) | no | same as #18 but lr 1e-3 |
| 23 | poet0 | 3.6518 | 38.55 | 3.5484 | 1e-3 | — | no | |
| 24 | **poet_h_noperm_rms_c8** | 3.6536 | 38.61 | 3.5578 | 1e-3 | 8 (rms) | **yes** | best head-aligned (RMS family) |
| 25 | poet_h_rms_c8 | 3.6541 | 38.63 | 3.5588 | 1e-3 | 8 (rms) | yes | |
| 26 | poet (vanilla, cayley) | ≈3.70 | ≈40.6 | ≈3.60 | 1e-3 | — | no | weakest POET family |
...
- **Tuned dense adam (lr 3e-3 → 3.4935, `ebndt1qj`)** is now 3rd overall — a −0.064 jump over the old lr-1e-3 baseline (3.5570), still beating the best POET (3.5160) by −0.022, but **−0.042 behind muon_kimi**. ⚠️ adam ran with cosine **min_lr_ratio 0.1** and has not been swept on min_lr / 2–3 seeds yet.
...
| **poet_lie_orth (+alt, Nesterov b1.95)** | `nestON_lr4` (current main, 2026-06-23) | **3.5160** | 33.65 | **lr 4e-3, scale 0.5, c=8 (eff∠ 0.016)**, muon, head-off, distributed, `lie_alternating=true`, **`lie_ortho_nesterov=true`, `lie_b1=0.95`** — **🏅 best POET / best PEFT (4th overall)**; reproduces legacy `ut682296` (3.5152), beats non-Nesterov champ by −0.007 (now config default) |
