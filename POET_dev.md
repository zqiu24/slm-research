...
| 3 | **poet_lie_orth (+alt, no-head, Nesterov b1.95, init_mup α4, lr5/c6)** | **3.4766** | 32.35 | 3.3752 | **5e-3** | 6 (**0.015**) | **no** | 🥇 **NEW BEST POET / best PEFT** (`lrsc_mup_lr5_ps50`, §2.10). At the §2.9 init optimum, pushing **dense lr 4e-3→5e-3 at scale 0.5** (eff∠ 0.012→0.015) lowers mup α4 from 3.4816 to **3.4766**; **normalized s2 ties at 3.4770** (#4). **Beats tuned dense adam (3.4935) by −0.017 and nGPT+Muon (3.4882) by −0.012** → POET still 3rd overall, −0.018/−0.025 behind nGPT/muon_kimi. The `init_none scale4`/lr4 cell (3.4804, `hi_none_s4_c6`) is the lr4 sibling. ⚠️ single seed |
