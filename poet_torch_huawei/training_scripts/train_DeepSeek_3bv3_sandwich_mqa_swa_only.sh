...
# DeepSeek 3B Training Script — SWA-only (no compression, for ablation)
# This script uses DeepSeek-3Bv2-sandwich-mqa-swa-only.yaml for model arguments
...
## main dir
MAIN_DIR=/public/Workspace ## ??
SAVE_DIR=$MAIN_DIR/baseline_3bv3_mqa_swa_only
...
DATE=$(date +%Y%m%d)
export WANDB_PROJECT="H200_baseline_3Bv3_mqa_swa_only" ## ??
...
# ==============================================================================
YAML_CONFIG="$SCRIPT_DIR/model_args/DeepSeek-3Bv2-sandwich-mqa-swa-only.yaml"
...
# ==============================================================================
echo "==============================================="
echo "Starting DeepSeek 3B Training (SWA-only)"
echo "==============================================="
