...
# DeepSeek 3B Training Script — Compress Attention + SWA
# This script uses DeepSeek-3Bv2-sandwich-mqa-cx-swa.yaml for model arguments
...
SAVE_DIR=$MAIN_DIR/baseline_3bv3_mqa_cx_swa
...
DATE=$(date +%Y%m%d)
export WANDB_PROJECT="H200_baseline_3Bv3_mqa_cx_swa" ## ??
...
# ==============================================================================
YAML_CONFIG="$SCRIPT_DIR/model_args/DeepSeek-3Bv2-sandwich-mqa-cx-swa.yaml"
...
# ==============================================================================
echo "==============================================="
echo "Starting DeepSeek 3B Training (Compress + SWA)"
echo "==============================================="
