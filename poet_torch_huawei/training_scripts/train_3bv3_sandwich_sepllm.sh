#!/bin/bash
# SepLLM variant of train_DeepSeek_3bv3_sandwich_mqa.sh + DeepSeek-3Bv2-sandwich-mqa.yaml
# Uses model_args/SepLLM-3Bv3-sandwich-mqa.yaml (MQA + sandwich norm + MoE + MTP; no NSA).
...
# SepLLM overrides (env; default matches YAML)
SEPLLM_WINDOW=${SEPLLM_WINDOW:-64}
SEPLLM_INIT_TOKENS=${SEPLLM_INIT_TOKENS:-3}
SEPLLM_KERNEL=${SEPLLM_KERNEL:-auto}
...
SAVE_DIR=$MAIN_DIR/sepllm_3bv3_sandwich_mqa
...
DATE=$(date +%Y%m%d)
export WANDB_PROJECT="H200_sepllm_3bv3_sandwich_mqa"
export WANDB_EXP_NAME="SepLLM3bv3_bf16_seqlen${SEQ_LEN}_node${NUM_NODES}_data${DATA_NAME}_w${SEPLLM_WINDOW}_init${SEPLLM_INIT_TOKENS}_kern${SEPLLM_KERNEL}_mbs${MBS}_gbs${GBS}_TP${TP}_PP${PP}_CP${CP}_EP${EP}_eval${EVAL_STEP}_save${SAVE_STEP}_${RUNTIME}"
...
# ==============================================================================
# Command-line Arguments (same positional convention as baseline)
# ==============================================================================
...
DATA_CACHE_PATH="$MAIN_DIR/data_cache/benchmark_cache_deepseek_3bv2_sepllm_${DATA_NAME}"
...
# ==============================================================================
YAML_CONFIG="$SCRIPT_DIR/model_args/SepLLM-3Bv3-sandwich-mqa.yaml"
...
echo "==============================================="
echo "SepLLM 3Bv3 sandwich + MQA — loading: $YAML_CONFIG"
echo "SepLLM: window=$SEPLLM_WINDOW init=$SEPLLM_INIT_TOKENS kernel=$SEPLLM_KERNEL"
echo "==============================================="
...
SEPLLM_OVERRIDE_ARGS=(
    --sepllm-local-window-size $SEPLLM_WINDOW
    --sepllm-init-token-count $SEPLLM_INIT_TOKENS
    --sepllm-kernel $SEPLLM_KERNEL
)
...
if [ -n "${WANDB_PROJECT:-}" ]; then
    WANDB_ARGS=(
        ...
        "--wandb-exp-name" "${WANDB_EXP_NAME:-sepllm_3bv3}"
...
echo "==============================================="
echo "Starting SepLLM 3Bv3 sandwich + MQA training"
echo "==============================================="
