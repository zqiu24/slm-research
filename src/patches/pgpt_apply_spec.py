...
def apply() -> None:
    ...
    from src.model.pgpt.output_scaling import attach_sz_scaling
    ...
    def _wrapped_builder(args, *a, **kw):
        ...
        def _ngpt_get_spec(use_te: bool, config: TransformerConfig):
            return build_pgpt_layer_spec(config)
        ...
        for m in chunks:
            ...
            _register_pgpt_norm_roles(m, expected_layers=int(args.num_layers))
...
def _register_pgpt_norm_roles(model, expected_layers: int) -> None:
