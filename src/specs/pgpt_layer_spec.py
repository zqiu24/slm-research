"""Build the Megatron ModuleSpec for a pgpt transformer layer.
...
from src.model.pgpt.attention import QKHyperNorm
...
def build_pgpt_layer_spec(config) -> ModuleSpec:
    ...
    submodules = TransformerLayerSubmodules(
        ...
        mlp=ModuleSpec(module=PGPTMLP),
        mlp_bda=IdentityFuncOp,
    )
    return ModuleSpec(module=PGPTTransformerLayer, submodules=submodules)
